...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Harika Gummadi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Skilled AI developer with a solid background in creating advanced machine learning models and neural networks. Also experienced in developing dynamic web applications and optimizing AI-driven solutions.</p>
